...
import com.ipasal.ipasalwebapp.dto.AddressDTO;
...
public class CheckoutHandler {
	...
	public void addBillingShippingInfo(CheckoutDTO checkout, AddressDTO billingShippingInfo) {
		checkout.setBillingShippingInfo(billingShippingInfo);
	}
	...
	public ShippingRateDTO addShippingRateInfo(ShippingRateDTO deliveryOption, List<ShippingRateDTO> shippingRates) {
		System.out.println("SELECTED SHIPPING METHOD CALLED.." + deliveryOption.getLocation());
		return shippingRates.stream()
				.filter(shippingRate -> deliveryOption.getLocation().equalsIgnoreCase(shippingRate.getLocation()))
				.findAny()
				.orElse(null);
	}
